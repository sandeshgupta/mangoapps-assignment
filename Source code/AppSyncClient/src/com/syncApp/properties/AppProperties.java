...
public class AppProperties {
	...
	public static void loadProperty(String path) {
		...
		try {
			input = FileProperties.class.getClassLoader().getResourceAsStream("ApplicationConfig.properties");
			...
			LISTEN_PORT = Integer.parseInt(prop.getProperty("LISTEN_PORT").toString());
